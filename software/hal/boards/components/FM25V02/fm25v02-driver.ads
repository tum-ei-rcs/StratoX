...
-- @summary
-- SPI protocol to CYPRESS FM25v02 (ferroelectric RAM, non-volatile)
package FM25v02.Driver with
  SPARK_Mode,
  Abstract_State => State
is
   MEMSIZE_BYTES : constant := 32_768;
...
private
   ...
   FM25v02_STARTUP_TIME_MS : constant Time

...
package STM32.GPIO is
   ...
   --  OTYPER constants
   Type_PP      : constant Boolean := False; -- Push/pull
   Type_OD      : constant Boolean := True; -- Open drain
   ...
   type GPIO_Pin_Type is new Integer range 1 .. 16;
   ---------------
   -- Registers --
   ---------------
   ...
   --  MODER array
   type MODER_Field_Array is array (0 .. 15) of Bits_2
   ...
   --  OSPEEDR array
   type OSPEEDR_Field_Array is array (0 .. 15) of Bits_2
     with Component_Size => 2, Size => 32;
   ...
   --  PUPDR array
   type PUPDR_Field_Array is array (0 .. 15) of Bits_2
     with Component_Size => 2, Size => 32;
   ...
   type IDR_Register is record
      ...
      IDR            : IDR_Field := (As_Array => True, Arr => (others => False));
      --  unspecified
      Reserved_16_31 : Half_Word;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
  ...
  -- subtype AFRL_Element is Interfaces.Bit_Types.UInt4;
   ...
   --  AFRL array
   type AFRL_Field_Array is array (0 .. 7) of Bits_4
   ...
   --  AFRH array
   type AFRH_Field_Array is array (8 .. 15) of Bits_4
     with Component_Size => 4, Size => 32;
   ...
   --GPIO_Port : array (GPIO_Port_Type) of aliased GPIO_Peripheral;


   --for GPIO_Port(<>) use GPIOA_Base;

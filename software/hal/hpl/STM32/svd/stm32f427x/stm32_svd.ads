...
--  extended with (checked) information from STM32F429x, 
--  and then adapted to work together with HAL.
...
package STM32_SVD is
   ...
   GPIOK_Base : constant System.Address :=
     System'To_Address (16#40022800#); -- added manually after svd2ada
   GPIOJ_Base : constant System.Address :=
     System'To_Address (16#40022400#); -- added manually after svd2ada
   ...
   --  unlike STM32F429, this controller does not have an LCD controller
   SAI_Base : constant System.Address :=
     System'To_Address (16#40015800#);
   DMA2D_Base : constant System.Address :=
     System'To_Address (16#4002B000#); -- added manually after svd2ada

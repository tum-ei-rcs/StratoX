...
csv_files = { 'AccX.csv', 'AccY.csv', 'AccZ.csv', 'GyrX.csv', 'GyrY.csv', 'GyrZ.csv', 'Press.csv', 'Temp.csv', ...
              'Alt.csv', 'Lat.csv', 'Lng.csv', 'NSats.csv','Spd.csv'}
outfile = [csv_dir 'rawdata.csv'];
